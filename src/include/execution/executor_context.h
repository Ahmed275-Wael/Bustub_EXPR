...
class ExecutorContext {
 public:
   ...
   */
  ExecutorContext(Transaction *transaction, CatalogManager *catalog, BufferPoolManager *bpm, TransactionManager *txn_mgr,
  ...
  /** @return the catalog */
  auto GetCatalog() -> CatalogManager* { return catalog_; }
