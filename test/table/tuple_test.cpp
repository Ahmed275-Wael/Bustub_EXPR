...
TEST(TupleTest,DISABLED_TableHeapTest) {
  ...
  Column col1{"a", TypeId::VARCHAR, 20, 0, 0, 0};
  Column col2{"b", TypeId::SMALLINT, 1, 0 , 0};
  Column col3{"c", TypeId::BIGINT ,2 ,0 ,0};
  Column col4{"d", TypeId::BOOLEAN,3,0,0};
  Column col5{"e", TypeId::VARCHAR, 16,4,0,0};
