...
// INDEX_TEMPLATE_ARGUMENTS
// BPLUSTREE_INDEX_TYPE::BPlusTreeIndex(std::string index_name, IndexSchema *key_schema, BufferPoolManager *buffer_pool_manager)
// :Index(index_name),
// comparator_(key_schema),
// container_(index_name,buffer_pool_manager,comparator_){}
...
INDEX_TEMPLATE_ARGUMENTS
bool BPLUSTREE_INDEX_TYPE::Destroy() {
  container_.Destroy();
  return true;
}
INDEX_TEMPLATE_ARGUMENTS
