...
bustub::BustubInstance* myInstance = nullptr;
...
auto main(int argc, char **argv) -> int {
  ...
  myInstance = new bustub::BustubInstance("test.db");
...
//  myInstance->GenerateMockTable();

  if (myInstance->buffer_pool_manager_ != nullptr) {
//   myInstance->GenerateTestTable();
  }
  ...
  while (true) {
    ...
    try {
      ...
      myInstance->ExecuteSql(query, writer);
